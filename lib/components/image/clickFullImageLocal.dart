...
class clickFullImagesLocal extends StatefulWidget {
  final List listImagesModel;
  final int current;

  const clickFullImagesLocal({Key? key, required this.listImagesModel, required this.current}) : super(key: key);

  @override
  _clickFullImagesLocalState createState() => _clickFullImagesLocalState();
}

class _clickFullImagesLocalState extends State<clickFullImagesLocal> {
  int _current = 0;
